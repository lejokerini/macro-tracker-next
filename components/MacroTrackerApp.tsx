...
export default function MacroTrackerApp() {
  ...
  return <main className="app">
    ...
    {tab === "profil" && <section className="grid">
      ...
      <div className="span-12"><label>Jeûne intermittent</label><select name="fasting" defaultValue={activeProfile?.fasting || (activeProfile?.intermittentFasting ? "16_8" : "none")}><option value="none">Aucun — 3 repas + collation</option><option value="16_8">16:8 — pas de petit-déjeuner</option><option value="18_6">18:6 — déjeuner + dîner + collation légère</option><option value="20_4">20:4 (Warrior) — 2 repas</option><option value="omad">OMAD — 1 seul repas par jour</option></select><p className="form-help">Le générateur de programme répartit tes calories sur les repas de la fenêtre choisie. Pour exclure un ingrédient (soja, gluten…), utilise les cases « Allergies / exclusions » ci-dessus.</p></div>
