...
export default function MacroTrackerApp() {
  ...
  function saveProfile(form: FormData) {
    ...
    const profile: Profile = {
      ...
      trainingDays: [1,2,3,4,5,6,0].filter(d => form.get(`day_${d}`)), intermittentFasting: !!form.get("intermittentFasting"), maxPrepTime: Number(form.get("maxPrepTime") || 30), cookingLevel: form.get("cookingLevel") as Profile["cookingLevel"],
    };
    setState(s => {
  ...
  return <main className="app">
    ...
    {tab === "profil" && <section className="grid">
      ...
      <div className="span-12"><label>Rythme alimentaire</label><label className="tag" style={{width:"auto"}}><input type="checkbox" name="intermittentFasting" defaultChecked={!!activeProfile?.intermittentFasting} style={{width:"auto"}}/> Jeûne intermittent (16:8) — pas de petit-déjeuner, calories réparties sur déjeuner, dîner et collation</label></div>
