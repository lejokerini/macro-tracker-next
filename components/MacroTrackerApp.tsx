...
export default function MacroTrackerApp() {
  ...
  return <main className="app">
    ...
    {tab === "profil" && <section className="grid">
      ...
      <div className="span-12"><label>Jeûne intermittent</label><select name="fasting" defaultValue={activeProfile?.fasting || (activeProfile?.intermittentFasting ? "16_8" : "none")}><option value="none">Aucun — 3 repas + collation</option><option value="16_8">16:8 — déjeuner, dîner, collation (pas de petit-déj)</option><option value="18_6">18:6 — déjeuner + dîner (fenêtre de 6h)</option><option value="20_4">20:4 (Warrior) — repas léger + gros dîner</option><option value="omad">OMAD — 1 seul repas par jour</option></select><p className="form-help">Le jeûne intermittent consiste à concentrer les repas sur une fenêtre horaire. Il peut aider à gérer le poids et certains marqueurs métaboliques, surtout parce qu'il réduit l'apport calorique — sans être supérieur à un simple déficit bien suivi (source : de Cabo &amp; Mattson, <em>New England Journal of Medicine</em>, 2019). Le générateur répartit tes calories sur la fenêtre choisie ; ajuste tes horaires librement. Pour exclure un ingrédient (soja, gluten…), utilise « Allergies / exclusions » ci-dessus.</p></div>
