...
const frCommonSeeds: FrSeed[] = [
  ...
  // Biscuits de marque (par 100 g)
  { id:"fr_speculoos", name:"Spéculoos (Lotus)", cat:"Plaisirs, Surgelés & Divers", kcal:502, p:5.9, c:68, f:20, fib:1.9, servingGrams:6.25, servingLabel:"biscuit", state:"standard", brand:"Lotus", icon:"🍪", diets:D_VEGE, allergens:["gluten","soja"], nutriScore:"D", novaGroup:4, aliases:["speculoos","spéculoos","lotus","biscuit lotus"] },
  { id:"fr_bn", name:"BN goût chocolat", cat:"Plaisirs, Surgelés & Divers", kcal:460, p:6.5, c:68, f:17, fib:2.5, servingGrams:14.4, servingLabel:"biscuit", state:"standard", brand:"BN", icon:"🍪", diets:D_VEGE, allergens:["gluten","lait","soja"], nutriScore:"D", novaGroup:4, aliases:["bn","bn chocolat","biscuit bn"] },
  { id:"fr_pepito", name:"Pépito", cat:"Plaisirs, Surgelés & Divers", kcal:475, p:5.5, c:68, f:19, fib:3, servingGrams:16.5, servingLabel:"biscuit", state:"standard", brand:"LU", icon:"🍪", diets:D_VEGE, allergens:["gluten","lait","soja"], nutriScore:"E", novaGroup:4, aliases:["pepito","pépito"] },
  { id:"fr_palmier", name:"Palmier", cat:"Plaisirs, Surgelés & Divers", kcal:480, p:6, c:60, f:24, fib:2, servingGrams:25, servingLabel:"palmier", state:"standard", icon:"🍪", diets:D_VEGE, allergens:["gluten","lait","oeufs"], nutriScore:"E", novaGroup:4, aliases:["palmier","palmito"] },
  { id:"fr_sable", name:"Sablé", cat:"Plaisirs, Surgelés & Divers", kcal:470, p:6, c:70, f:18, fib:2, servingGrams:12, servingLabel:"biscuit", state:"standard", icon:"🍪", diets:D_VEGE, allergens:["gluten","lait","oeufs"], nutriScore:"D", novaGroup:4, aliases:["sable","sablé","sable breton"] },
  // Chocolats de marque (par 100 g)
  { id:"fr_milka", name:"Milka (tablette lait)", cat:"Plaisirs, Surgelés & Divers", kcal:534, p:6.3, c:58.9, f:29.5, fib:2.2, state:"standard", brand:"Milka", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["milka","tablette milka","chocolat milka"] },
  { id:"fr_mms", name:"M&M's", cat:"Plaisirs, Surgelés & Divers", kcal:484, p:4.8, c:71, f:19, fib:2.5, state:"standard", brand:"M&M's", icon:"🍫", diets:D_VEGE, allergens:["lait","fruits_a_coque","soja"], nutriScore:"E", novaGroup:4, aliases:["m&m's","m&m","mms","m and m"] },
  { id:"fr_ferrero_rocher", name:"Ferrero Rocher", cat:"Plaisirs, Surgelés & Divers", kcal:610, p:8.7, c:44, f:44, fib:3, servingGrams:12.5, servingLabel:"chocolat", state:"standard", brand:"Ferrero", icon:"🍫", diets:D_VEGE, allergens:["lait","fruits_a_coque","soja","gluten"], nutriScore:"E", novaGroup:4, aliases:["ferrero rocher","ferrero","rocher"] },
  { id:"fr_bounty", name:"Bounty", cat:"Plaisirs, Surgelés & Divers", kcal:473, p:4, c:58, f:25, fib:2, servingGrams:28.5, servingLabel:"barre", state:"standard", brand:"Bounty", icon:"🍫", diets:D_VEGE, allergens:["lait","soja"], nutriScore:"E", novaGroup:4, aliases:["bounty","barre bounty"] },
  { id:"fr_toblerone", name:"Toblerone", cat:"Plaisirs, Surgelés & Divers", kcal:535, p:5.3, c:60, f:29, fib:1.7, state:"standard", brand:"Toblerone", icon:"🍫", diets:D_VEGE, allergens:["lait","fruits_a_coque","oeufs"], nutriScore:"E", novaGroup:4, aliases:["toblerone"] },
  { id:"fr_kinder_surprise", name:"Kinder Surprise", cat:"Plaisirs, Surgelés & Divers", kcal:568, p:8.7, c:53, f:35, fib:2.4, servingGrams:20, servingLabel:"œuf", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["kinder surprise","kinder oeuf"] },
  { id:"fr_kinder_surprise_maxi", name:"Kinder Surprise Maxi", cat:"Plaisirs, Surgelés & Divers", kcal:568, p:8.7, c:53, f:35, fib:2.4, servingGrams:100, servingLabel:"œuf", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["kinder surprise maxi","kinder maxi oeuf","kinder gros oeuf"] },
  { id:"fr_kinder_chocolat", name:"Kinder Chocolat", cat:"Plaisirs, Surgelés & Divers", kcal:566, p:8.7, c:53.5, f:35, fib:1.5, servingGrams:12.5, servingLabel:"barre", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["kinder chocolat","kinder barre","barre kinder"] },
  { id:"fr_kinder_maxi", name:"Kinder Maxi", cat:"Plaisirs, Surgelés & Divers", kcal:566, p:8.7, c:53.5, f:35, fib:1.5, servingGrams:21, servingLabel:"barre", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["kinder maxi","kinder chocolat maxi"] },
  { id:"fr_kinder_schokobons", name:"Kinder Schoko-Bons", cat:"Plaisirs, Surgelés & Divers", kcal:576, p:8.3, c:52.5, f:36.6, fib:2, servingGrams:5.3, servingLabel:"bonbon", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["schoko-bons","schokobons","kinder schoko bons","chocobon"] },
  { id:"fr_kinder_pingui", name:"Kinder Pingui", cat:"Plaisirs, Surgelés & Divers", kcal:441, p:6, c:40, f:28, fib:1.5, servingGrams:30, servingLabel:"part", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","gluten","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["kinder pingui","pingui"] },
  { id:"fr_kinder_tronky", name:"Kinder Tronky", cat:"Plaisirs, Surgelés & Divers", kcal:560, p:8, c:52, f:35, fib:2, servingGrams:18, servingLabel:"barre", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","gluten","fruits_a_coque"], nutriScore:"E", novaGroup:4, reliability:"estime", aliases:["kinder tronky","tronky"] },
  { id:"fr_kinder_cards", name:"Kinder Cards", cat:"Plaisirs, Surgelés & Divers", kcal:564, p:8, c:52, f:35, fib:1.5, servingGrams:12.8, servingLabel:"biscuit", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","gluten","fruits_a_coque"], nutriScore:"E", novaGroup:4, reliability:"estime", aliases:["kinder cards"] },
  { id:"fr_kinder_happy_hippo", name:"Kinder Happy Hippo", cat:"Plaisirs, Surgelés & Divers", kcal:570, p:9, c:53, f:35, fib:2, servingGrams:20.7, servingLabel:"hippo", state:"standard", brand:"Kinder", icon:"🍫", diets:D_VEGE, allergens:["lait","soja","gluten","fruits_a_coque"], nutriScore:"E", novaGroup:4, reliability:"estime", aliases:["kinder happy hippo","happy hippo"] },
  { id:"fr_nesquik", name:"Chocolat en poudre (Nesquik)", cat:"Épicerie, Huiles & Condiments", kcal:377, p:4.5, c:80, f:3.5, fib:7, state:"standard", brand:"Nesquik", icon:"🍫", diets:D_VEGAN, allergens:[], nutriScore:"C", novaGroup:4, aliases:["nesquik","chocolat en poudre","poudre chocolatee","cacao en poudre sucre"] },
  // Fromages de marque (par 100 g)
  ...
  // Glaces de marque (par 100 g)
  { id:"fr_benjerry", name:"Ben & Jerry's Cookie Dough", cat:"Plaisirs, Surgelés & Divers", kcal:280, p:4.4, c:34, f:14, fib:1, state:"standard", brand:"Ben & Jerry's", icon:"🍨", diets:D_VEGE, allergens:["lait","oeufs","gluten","soja"], nutriScore:"E", novaGroup:4, aliases:["ben and jerry's","ben & jerry","ben jerry","cookie dough"] },
  { id:"fr_haagen_dazs", name:"Häagen-Dazs vanille", cat:"Plaisirs, Surgelés & Divers", kcal:253, p:4.6, c:21.5, f:16.5, fib:0, state:"standard", brand:"Häagen-Dazs", icon:"🍨", diets:D_VEGE, allergens:["lait","oeufs"], nutriScore:"E", novaGroup:4, aliases:["haagen dazs","häagen-dazs","haagen dazs vanille"] },
  { id:"fr_magnum", name:"Magnum (bâtonnet)", cat:"Plaisirs, Surgelés & Divers", kcal:290, p:3.6, c:32, f:17, fib:1, servingGrams:79, servingLabel:"bâtonnet", state:"standard", brand:"Magnum", icon:"🍦", diets:D_VEGE, allergens:["lait","soja","fruits_a_coque"], nutriScore:"E", novaGroup:4, aliases:["magnum","glace magnum"] },
  { id:"fr_cornetto", name:"Cornetto", cat:"Plaisirs, Surgelés & Divers", kcal:270, p:3.5, c:33, f:13, fib:1, servingGrams:90, servingLabel:"cornet", state:"standard", brand:"Cornetto", icon:"🍦", diets:D_VEGE, allergens:["gluten","lait","soja"], nutriScore:"E", novaGroup:4, aliases:["cornetto","cone glace","cornet glace"] },
  // Sodas (par 100 ml)
  { id:"fr_fanta", name:"Fanta orange", cat:"Plaisirs, Surgelés & Divers", kcal:38, p:0, c:9, f:0, fib:0, unit:"ml", state:"standard", brand:"Fanta", icon:"🥤", diets:D_VEGAN, allergens:[], nutriScore:"E", novaGroup:4, aliases:["fanta","fanta orange"] },
  { id:"fr_sprite", name:"Sprite", cat:"Plaisirs, Surgelés & Divers", kcal:33, p:0, c:8, f:0, fib:0, unit:"ml", state:"standard", brand:"Sprite", icon:"🥤", diets:D_VEGAN, allergens:[], nutriScore:"E", novaGroup:4, aliases:["sprite"] },
  { id:"fr_7up", name:"7up", cat:"Plaisirs, Surgelés & Divers", kcal:32, p:0, c:8, f:0, fib:0, unit:"ml", state:"standard", brand:"7up", icon:"🥤", diets:D_VEGAN, allergens:[], nutriScore:"E", novaGroup:4, aliases:["7up","seven up"] },
  { id:"fr_schweppes", name:"Schweppes tonic", cat:"Plaisirs, Surgelés & Divers", kcal:38, p:0, c:9, f:0, fib:0, unit:"ml", state:"standard", brand:"Schweppes", icon:"🥤", diets:D_VEGAN, allergens:[], nutriScore:"E", novaGroup:4, aliases:["schweppes","tonic","schweppes agrumes"] },
  { id:"fr_limonade", name:"Limonade", cat:"Plaisirs, Surgelés & Divers", kcal:40, p:0, c:10, f:0, fib:0, unit:"ml", state:"standard", icon:"🥤", diets:D_VEGAN, allergens:[], nutriScore:"E", novaGroup:4, aliases:["limonade"] },
  // Chips & apéritif (parfums, par 100 g)
  { id:"fr_lays_bbq", name:"Chips barbecue (Lay's)", cat:"Plaisirs, Surgelés & Divers", kcal:520, p:6, c:53, f:32, fib:4, state:"standard", brand:"Lay's", icon:"🥔", diets:D_VEGE, allergens:["lait"], nutriScore:"D", novaGroup:4, aliases:["chips barbecue","lays barbecue","lay's barbecue","chips bbq"] },
  { id:"fr_lays_paprika", name:"Chips paprika (Lay's)", cat:"Plaisirs, Surgelés & Divers", kcal:530, p:6, c:52, f:33, fib:4, state:"standard", brand:"Lay's", icon:"🥔", diets:D_VEGE, allergens:["lait"], nutriScore:"D", novaGroup:4, aliases:["chips paprika","lays paprika","lay's paprika"] },
